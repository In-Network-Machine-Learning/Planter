...
if __name__ == '__main__':
    ...
    # train_X, train_y, test_X, test_y, used_features = load_data(Planter_config['model config']['number of features'])
    #
    # run_model(train_X, train_y, test_X, test_y, used_features)
