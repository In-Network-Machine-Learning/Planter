...
def resource_prediction():
    ...
    print('Exact match entries: ',Planter_config['p4 config']["decision table size"]+1024*Planter_config['p4 config']["number of trees"]*Planter_config['p4 config']["number of depth"])
