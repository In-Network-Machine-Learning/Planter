...
control SwitchProcessing(
    ...
    action extract_feature0(out bit<20> meta_code, bit<20> tree){
        meta_code = tree;
    }
    ...
    action extract_feature2(out bit<24> meta_code, bit<24> tree){
        meta_code = tree;
    }
    ...
    table lookup_leaf_id0 {
        key = { (bit<10>) code_f0[2:0]:exact @name("lookup_leaf_id0");
                (bit<10>) code_f1[2:0]:exact @name("lookup_leaf_id0");
                (bit<10>) code_f2[3:0]:exact @name("lookup_leaf_id0");
                (bit<10>) code_f3[2:0]:exact @name("lookup_leaf_id0");
    ...
    table lookup_leaf_id1 {
        key = { (bit<10>) code_f0[5:3]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f1[5:3]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f2[7:4]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f3[5:3]:exact @name("lookup_leaf_id1");
    ...
    table lookup_leaf_id2 {
        key = { (bit<10>) code_f0[8:6]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f1[8:6]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f2[11:8]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f3[8:6]:exact @name("lookup_leaf_id2");
    ...
    table lookup_leaf_id3 {
        key = { (bit<10>) code_f0[11:9]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f1[11:9]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f2[15:12]:exact @name("lookup_leaf_id3");
    ...
    table lookup_leaf_id4 {
        key = { (bit<10>) code_f0[15:12]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f1[13:12]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f2[19:16]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f3[13:12]:exact @name("lookup_leaf_id4");
    ...
    table lookup_leaf_id5 {
        key = { (bit<10>) code_f0[19:16]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f1[15:14]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f2[23:20]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f3[15:14]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f4[5:5]:exact @name("lookup_leaf_id5");
                }
        actions={
            read_prob5;
