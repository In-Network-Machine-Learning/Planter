...
control SwitchProcessing(
    ...
    action extract_feature0(out bit<7> meta_code, bit<7> tree){
        meta_code = tree;
    }
    ...
    action extract_feature3(out bit<13> meta_code, bit<13> tree){
        meta_code = tree;
    }
    ...
    table lookup_leaf_id1 {
        key = { (bit<10>) code_f0[2:2]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f1[3:2]:exact @name("lookup_leaf_id1");
    ...
    table lookup_leaf_id2 {
        key = { (bit<10>) code_f0[4:3]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f1[6:4]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f2[7:5]:exact @name("lookup_leaf_id2");
    ...
    table lookup_leaf_id3 {
        key = { (bit<10>) code_f0[5:5]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f1[7:7]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f2[8:8]:exact @name("lookup_leaf_id3");
    ...
    table lookup_leaf_id4 {
        key = { (bit<10>) code_f0[6:6]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f1[9:8]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f2[11:9]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f3[12:12]:exact @name("lookup_leaf_id4");
                }
        actions={read_prob4;}
        size = 8;
    }
