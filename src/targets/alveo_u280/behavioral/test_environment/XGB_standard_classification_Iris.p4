...
control SwitchProcessing(
    ...
    table lookup_leaf_id0 {
        key = { (bit<10>) code_f0[0:0]:exact @name("lookup_leaf_id0");
                (bit<10>) code_f1[0:0]:exact @name("lookup_leaf_id0");
                (bit<10>) code_f2[1:0]:exact @name("lookup_leaf_id0");
                (bit<10>) code_f3[0:0]:exact @name("lookup_leaf_id0");
                }
        actions={
            read_prob0;
    ...
    table lookup_leaf_id1 {
        key = { (bit<10>) code_f0[1:1]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f1[1:1]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f2[4:2]:exact @name("lookup_leaf_id1");
                (bit<10>) code_f3[2:1]:exact @name("lookup_leaf_id1");
                }
        actions={
            read_prob1;
    ...
    table lookup_leaf_id2 {
        key = { (bit<10>) code_f0[2:2]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f1[2:2]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f2[6:5]:exact @name("lookup_leaf_id2");
                (bit<10>) code_f3[4:3]:exact @name("lookup_leaf_id2");
                }
        actions={
            read_prob2;
    ...
    table lookup_leaf_id3 {
        key = { (bit<10>) code_f0[3:3]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f1[3:3]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f2[8:7]:exact @name("lookup_leaf_id3");
                (bit<10>) code_f3[5:5]:exact @name("lookup_leaf_id3");
                }
        actions={
            read_prob3;
    ...
    table lookup_leaf_id4 {
        key = { (bit<10>) code_f0[4:4]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f1[4:4]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f2[11:9]:exact @name("lookup_leaf_id4");
                (bit<10>) code_f3[7:6]:exact @name("lookup_leaf_id4");
                }
        actions={
            read_prob4;
    ...
    table lookup_leaf_id5 {
        key = { (bit<10>) code_f0[5:5]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f1[5:5]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f2[13:12]:exact @name("lookup_leaf_id5");
                (bit<10>) code_f3[9:8]:exact @name("lookup_leaf_id5");
                }
        actions={
            read_prob5;
