...
def common_logics(fname, config):
    with open(fname, 'a') as ingress:
        ...
        ingress.write("        /* snake test configuration */\n" 
                      "        send(ig_intr_md.ingress_port + 4);\n" 
                      ...
                      "            send(256);\n" 
                      "        }\n" 
                      "        if (ig_intr_md.ingress_port == 316) {\n" 
                      "            send(384);\n" 
                      "        }\n" 
                      "        if (ig_intr_md.ingress_port == 444) {\n" 
                      "            send(0);\n" 
                      "        }\n")